...
import { tourFlowStyles } from "../flow/TourFlowSvg";
...
export type RenderedDraft = TourDraft & { readonly restored?: boolean };

export function renderTourEditorHtml(draft: RenderedDraft): string {
